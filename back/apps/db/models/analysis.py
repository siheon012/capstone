...
class VideoAnalysis(models.Model):
    ...
    # 연관 비디오
    video = models.ForeignKey('db.Video', on_delete=models.CASCADE, related_name='analyses')
...
class AnalysisJob(models.Model):
    ...
    # 연관 비디오
    video = models.ForeignKey('db.Video', on_delete=models.CASCADE, related_name='analysis_jobs')
    ...
    # 결과 및 로그
    result_s3_key = models.CharField(max_length=1024, blank=True, help_text="Result S3 key")
...
class DepthData(models.Model):
    ...
    # 연관 비디오
    video = models.ForeignKey('db.Video', on_delete=models.CASCADE, related_name='depth_data')
...
class DisplayData(models.Model):
    ...
    # 연관 비디오
    video = models.ForeignKey('db.Video', on_delete=models.CASCADE, related_name='display_data')
