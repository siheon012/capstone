...
export default function UploadedVideoPage() {
  ...
  const allFilteredAndSortedVideos = videos
    .filter((video) => {
      ...
      const matchesFilter =
        filterEvent === "all" || (filterEvent === "none" && !video.majorEvent) || video.majorEvent === filterEvent
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white">Deep Sentinel</h1>
    ...
    <div className="min-h-screen bg-[#1a1f2c] text-gray-100 flex flex-col">
      ...
      >
        ...
        <div className="mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">업로드된 비디오</h2>
          ...
          {currentVideos.length === 0 ? (
            <Card className="bg-[#242a38] border-0 shadow-lg">
              <CardContent className="p-12 text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">업로드된 비디오가 없습니다</h3>
                <p className="text-gray-400 mb-6">CCTV 영상을 업로드하여 분석을 시작하세요.</p>
                <Link href="/">
            ...
            currentVideos.map((video) => (
              <Card key={video.id} className="bg-[#242a38] border-0 shadow-lg hover:bg-[#2a3142] transition-colors">
                <CardContent className="p-3 sm:p-6">
                    ...
                    <div className="flex-1 min-w-0 w-full">
                      ...
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <div className="flex gap-2">
                          <Link href={`/uploaded_video/${video.id}/sessions`} className="flex-1 sm:flex-none">
                            <Button
                              size="sm"
                          ...
                          <Link href={`/uploaded_video/${video.id}`} className="flex-1 sm:flex-none">
                            <Button
                              size="sm"
            ...
            <CardContent className="p-3 sm:p-4">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="text-xs sm:text-sm text-gray-400 order-2 sm:order-1">
                  {startIndex + 1}-{Math.min(endIndex, totalVideos)} / {totalVideos}개
                </div>
                ...
                <div className="flex items-center gap-1 sm:gap-2 order-1 sm:order-2">
                  ...
                  <div className="flex items-center gap-1">
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => {
                      ...
                      if (!showPage) {
                        if (page === currentPage - (showRange + 1) || page === currentPage + (showRange + 1)) {
                          return (
      ...
      >
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-[#00e6b4] mb-3">AI 기반 CCTV 영상 분석 플랫폼</h2>
            <p className="text-gray-400 text-lg">실시간 이벤트 감지 • 스마트 보안 솔루션 • Deep Sentinel</p>
          </div>
