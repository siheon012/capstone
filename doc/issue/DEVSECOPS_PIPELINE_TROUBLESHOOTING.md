...
![Trivy Deploy Stop](../../picture/github_actions/trivy%20deploy%20stop.png)
_배포 차단: CRITICAL 취약점 발견 시 자동 중단_

![Trivy Backend Security Scan](../../picture/github_actions/trivy%20deploy%20stop%20backend.png)
