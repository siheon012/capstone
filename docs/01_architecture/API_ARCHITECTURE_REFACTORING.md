...
| 항목            | Before                              | After                      |
| --------------- | ----------------------------------- | -------------------------- |
| **라우팅 방식** | Host-based (api.deepsentinel.cloud) | Path-based (/api/_, /db/_) |
...
- [PRODUCTION_403_ISSUE_RESOLUTION.md](../06_troubleshooting/PRODUCTION_403_ISSUE_RESOLUTION.md)
- [PRODUCTION_404_ROUTING_ISSUES.md](../06_troubleshooting/PRODUCTION_404_ROUTING_ISSUES.md)
