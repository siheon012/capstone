...
urlpatterns = [
    ...
    path(
        "prompt/history/<str:session_id>/",
        prompt.get_session_detail,
    ...
    path(
        "videos/<int:video_id>/summary/status/",
        summary.check_summary_status,
        name="check_summary_status",
    ),
    ...
    path(
        "s3/video/<int:video_id>/download/",
        s3.get_video_download_url,
        name="s3_get_video_download_url",
    ),
