...
class EventService:
    ...
    def get_events_by_video(self, video_id: str, event_type: Optional[str] = None) -> List[Event]:
        """
        비디오별 이벤트 조회
    ...
    def update_event(self, event_id: int, update_data: Dict[str, Any]) -> Optional[Event]:
        """
        이벤트 업데이트
