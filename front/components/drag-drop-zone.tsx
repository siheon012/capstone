  ...
  return (
    ...
    >
      ...
      >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">CCTV 영상 분석을 위한 파일 업로드</p>
                </div>
              </div>
        ...
        <Card
          className={`${isMobile ? 'h-auto' : 'h-full md:h-auto'} border-0 md:border-2 border-dashed transition-all duration-300 group ${
            isDragOver
          ...
          onDrop={handleDrop}
        >
          <CardContent className={`p-6 md:p-12 relative ${isMobile ? 'h-auto min-h-[calc(100vh-80px)] max-h-[calc(100vh-80px)] overflow-y-auto' : 'h-full min-h-screen md:min-h-0 max-h-screen md:max-h-none overflow-y-auto md:overflow-visible'} flex flex-col justify-center`}>
            {/* 데스크톱 전용 닫기 버튼 */}
            {!isMobile && (
              <Button
                variant="ghost"
            ...
            <div className="flex flex-col md:flex-row flex-1 md:flex-none gap-8">
              ...
              <div className="w-full md:w-1/2 pr-0 md:pr-8 flex flex-col items-center justify-start flex-1 md:flex-none py-8 md:py-16">
                ...
                <h2
                  className={`text-2xl font-bold mb-4 transition-colors text-center ${
                    selectedFile ? "text-[#00e6b4]" : isDragOver ? "text-[#00e6b4]" : "text-white"
                  }`}
                >
                  {selectedFile 
                    ? "파일이 선택됨" 
              ...
              <div className="w-full md:w-1/2 pl-0 md:pl-8 flex flex-col items-center justify-start flex-1 md:flex-none py-8 md:py-16">
                ...
                <h2
                  className={`text-2xl font-bold mb-4 transition-colors text-center ${
                    selectedDateTime ? "text-[#00e6b4]" : isDragOver ? "text-[#00e6b4]" : "text-white"
                  }`}
                >
                  {selectedDateTime 
                    ? "시간이 설정됨" 
                ...
                <p className="text-gray-400 mb-8 leading-relaxed text-center">
                  {selectedDateTime ? (
                    ...
                    <>
                      ...
                      <br />
                      <span className="text-sm">정확한 시간 분석을 위해 필요합니다</span>
                    </>
                  )}
                </p>
