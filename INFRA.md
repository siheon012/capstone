...
![Full Infrastructure](docs/assets/terraform/full_shot.svg)

**▲ Complete infrastructure visualization generated by [Rover](https://github.com/im2nguyen/rover)**
...
<img src="docs/assets/terraform/network resources.png" width="600">
...
<img src="docs/assets/terraform/storage resources.png" width="600">
...
<img src="docs/assets/terraform/security resources.png" width="600">
...
<img src="docs/assets/terraform/compute resource.png" width="600">
...
<img src="docs/assets/terraform/pipeline resources.png" width="600">

**SQS, Lambda, EventBridge**

- SQS for async job queue
- Lambda for SQS → Batch orchestration
- EventBridge for scheduled cleanup tasks

### 6. IAM Resources

<img src="docs/assets/terraform/iam resources.png" width="600">
